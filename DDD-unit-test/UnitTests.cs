...
{
    //unit test for registration so the name email and password are valid
    ...
    //this is for booking system, and they test if it is valid or not
...
//this is for the role validation and they test if it is valid or not
...
//self report test to check if the rating is valid or not with the raitings there and other things
